...
if($username == null || $location == null || $first_name == null ||
   $last_name == null || $password == null || $email == null ||$phone_number == null){
        $err_msg = "All Valus Not Entered";
        include("../db_error.php");
   }else{
       require_once("../dbconnect.php");
       $query = 'INSERT INTO users(user_id, username, location,first_name, last_name, password, email, phone_number) VALUES(:user_id, :username, :location, :first_name, :last_name, :password, :email, :phone_number)';
    ...
    $students_statement = $db->prepare($query);
