...
def mix_images(image1, image2, channel1, channel2):
    ...
    out = None
    ### YOUR CODE HERE
    img1_1, img1_2 = np.hsplit(image1, 2)
    img2_1, img2_2 = np.hsplit(image2, 2)
    
    img1_1 = rgb_exclusion(img1_1, channel1)
    img2_2 = rgb_exclusion(img2_2, channel2)

    out = np.concatenate([img1_1, img2_2], 1)
    ### END YOUR CODE
